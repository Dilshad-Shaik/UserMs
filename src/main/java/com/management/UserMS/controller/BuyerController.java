...
public class BuyerController {
	...
	public  String addProductToWishlist(@PathVariable Integer prodid, @PathVariable String productName) {
		try {
		System.out.println("hellooo");
		logger.info("ADD product to wishlist request{}",productName);
	...
	public  String addProductToCart(@PathVariable Integer prodid,@PathVariable String productName, @PathVariable Integer quantity) {
		try {
